...
/**
* Removes and returns the entry (a key, value pair) with the BIGGEST OR SMALLEST key,
* depending on the current state of the priority queue (either MAX or MIN).
*/
...
/**
* Returns the top entry (with the MAXIMUM or the MINIMUM key,
* depending on whether it is a MAX- or MIN-priority queue, without removing the entry.
*/
...
/**
* Returns the current state (MAX or MIN) of the priority queue.
*/
